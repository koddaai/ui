---
title: DataTable
description: Tabela de dados com busca, filtros, paginação, sorting, seleção, ações e visibilidade de colunas. Baseada no dashboard kodda Billing.
---
...
import { DataTableColumnHeader } from "@/components/kodda/data-table"
```

## Layout

O layout segue o padrão do dashboard kodda Billing:
...
```tsx
import { SimpleSortableHeader } from "@/components/kodda/data-table"
