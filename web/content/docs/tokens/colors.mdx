---
title: Cores
description: Paleta de cores da marca e cores semânticas do kodda UI.
---
...
| Cor | Hex | Token | Uso |
|-----|-----|-------|-----|
| Verde-limão | `#D3FD54` | `kodda-blue` | Cor primária, CTAs, destaques |
| Preto | `#000000` | `kodda-black` | Textos, fundos escuros, contraste |
| Branco | `#FDFDFB` | `kodda-white` | Fundos claros, texto em fundo escuro |
| Cinza | `#676767` | `kodda-gray` | Textos secundários, elementos neutros |
| Roxo | `#A630DA` | `kodda-purple` | Destaques, CTAs secundários |

### Uso com Tailwind

```html
<button class="bg-kodda-blue text-kodda-black">Ação principal</button>
<span class="text-kodda-gray">Texto secundário</span>
<a class="text-kodda-purple">Link de destaque</a>
```

### Uso via TypeScript

```tsx
import { brandColors, semanticColors } from "@koddaai/ui/tokens/colors"
