...
/**
 * Resolve the kodda-ui repo root directory.
...
/**
 * Fetch registry from local path (relative to the kodda-ui repo root).
 ...
 *
 * Example:
 *   registryUrl = "https://raw.githubusercontent.com/kodda/ui/main/registry/registry.json"
 *   filePath    = "src/components/composites/status-badge/status-badge.tsx"
 *   → fetches    "https://raw.githubusercontent.com/kodda/ui/main/src/components/composites/status-badge/status-badge.tsx"
 */
